...
namespace BTSimulation
{
    public partial class certificateDisplay : Form
    {
        public certificateDisplay()
        {
            ...
            Height = BTSimulation.Properties.Resources.certificate.Height / 2 + 50;
            Width = BTSimulation.Properties.Resources.certificate.Width / 2 + 25;
            certPicture.Height = BTSimulation.Properties.Resources.certificate.Height / 2;
            certPicture.Width = BTSimulation.Properties.Resources.certificate.Width / 2;
            certPicture.Location = new Point(0, 25);
            certPicture.Image = BTSimulation.Properties.Resources.certificate;
        ...
        private void certPicture_Paint(object sender, System.Windows.Forms.PaintEventArgs g)
        {
            ...
            e.DrawImage(new Bitmap(BTSimulation.Properties.Resources.certificate), 0, 0, 1100, 850);
